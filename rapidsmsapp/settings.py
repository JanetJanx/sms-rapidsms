# Django settings for rapidsmsapp project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a rapidsmsapp directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'rapidsmsapp')
...
SECRET_KEY = 'jd&ik1omni)qp@#(ad9vioxj@qix0u0*an_$6&d)oc5bf!r-qw'
...
ROOT_URLCONF = 'rapidsmsapp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rapidsmsapp.wsgi.application'
